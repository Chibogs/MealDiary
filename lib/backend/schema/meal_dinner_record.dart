...
class MealDinnerRecord extends FirestoreRecord {
  MealDinnerRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('meal_dinner');

  static Stream<MealDinnerRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => MealDinnerRecord.fromSnapshot(s));

  static Future<MealDinnerRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => MealDinnerRecord.fromSnapshot(s));

  static MealDinnerRecord fromSnapshot(DocumentSnapshot snapshot) =>
      MealDinnerRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static MealDinnerRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      MealDinnerRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'MealDinnerRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is MealDinnerRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createMealDinnerRecordData({
  String? mealName,
  String? mealImage,
...
class MealDinnerRecordDocumentEquality implements Equality<MealDinnerRecord> {
  const MealDinnerRecordDocumentEquality();

  @override
  bool equals(MealDinnerRecord? e1, MealDinnerRecord? e2) {
  ...
  @override
  int hash(MealDinnerRecord? e) => const ListEquality().hash([
        e?.mealName,
        e?.mealImage,
        e?.mealIngredients,
        e?.mealAllergens,
  ...
  @override
  bool isValidKey(Object? o) => o is MealDinnerRecord;
}
