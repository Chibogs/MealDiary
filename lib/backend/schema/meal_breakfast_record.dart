...
class MealBreakfastRecord extends FirestoreRecord {
  MealBreakfastRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('meal_breakfast');

  static Stream<MealBreakfastRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => MealBreakfastRecord.fromSnapshot(s));

  static Future<MealBreakfastRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => MealBreakfastRecord.fromSnapshot(s));

  static MealBreakfastRecord fromSnapshot(DocumentSnapshot snapshot) =>
      MealBreakfastRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static MealBreakfastRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      MealBreakfastRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'MealBreakfastRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is MealBreakfastRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createMealBreakfastRecordData({
  String? mealName,
  String? mealImage,
...
class MealBreakfastRecordDocumentEquality
    implements Equality<MealBreakfastRecord> {
  const MealBreakfastRecordDocumentEquality();

  @override
  bool equals(MealBreakfastRecord? e1, MealBreakfastRecord? e2) {
  ...
  @override
  int hash(MealBreakfastRecord? e) => const ListEquality().hash([
        e?.mealName,
        e?.mealImage,
        e?.mealIngredients,
        e?.mealAllergens,
  ...
  @override
  bool isValidKey(Object? o) => o is MealBreakfastRecord;
}
