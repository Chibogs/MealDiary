...
/// Functions to query MealBreakfastRecords (as a Stream and as a Future).
Future<int> queryMealBreakfastRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MealBreakfastRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MealBreakfastRecord>> queryMealBreakfastRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MealBreakfastRecord.collection,
      MealBreakfastRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MealBreakfastRecord>> queryMealBreakfastRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query MealLunchRecords (as a Stream and as a Future).
Future<int> queryMealLunchRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MealLunchRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MealLunchRecord>> queryMealLunchRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MealLunchRecord.collection,
      MealLunchRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MealLunchRecord>> queryMealLunchRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query MealDinnerRecords (as a Stream and as a Future).
Future<int> queryMealDinnerRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MealDinnerRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MealDinnerRecord>> queryMealDinnerRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MealDinnerRecord.collection,
      MealDinnerRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MealDinnerRecord>> queryMealDinnerRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query UserRecipeRecords (as a Stream and as a Future).
Future<int> queryUserRecipeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserRecipeRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserRecipeRecord>> queryUserRecipeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UserRecipeRecord.collection,
      UserRecipeRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserRecipeRecord>> queryUserRecipeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
